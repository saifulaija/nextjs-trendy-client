      ...
      <div className="container mx-auto md:flex justify-between items-start p-10 ">
        <div className="leading-7 flex-shrink-0 w-full md:w-1/3">
          <div className="flex flex-col justify-start items-start ">
            <div>
              {" "}
              <h5 className=" font-semibold text-gray-200 tracking-wide border-b-2 border-primary">
                ABOUT US
              </h5>
        ...
        <div className="leading-7 flex-shrink-0 w-full md:w-1/3">
          <div>
            ...
            <div>
              {" "}
              <img
                src="https://voguesultana.com/images/payments.png"
                height={100}
                width={400}
                alt="logo"
              />{" "}
          ...
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="mb-8">
              ...
              <p className="text-balance text-gray-200 text-sm mt-3">
                Join Our Facebook Group Trendy <br /> Offer and Review and Like
                Our Page.
              </p>
            </div>
            <div>
